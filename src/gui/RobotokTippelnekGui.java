...
public class RobotokTippelnekGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnTippIndit = new javax.swing.JButton();
        ...
        btnTippIndit.setText("Tippelő robotok indítása");
        btnTippIndit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnTippInditActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnTippIndit, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private int random(int randomFelso, int randomAlso){
        int db = randomFelso - randomAlso + 1;
        int randomSzam;
        randomSzam = (int) (Math.random() * db ) + 1;
        return randomSzam;
    }
    
    private void btnGeneralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGeneralActionPerformed
        // TODO add your handling code here:
        int randomAlso = (int) numMin.getValue();
        int randomFelso = (int) numMax.getValue();

        if (randomAlso >= randomFelso){
            JOptionPane.showMessageDialog(null, "A kisebb érték nem lehet nagyobb a MAX-nál!");
        }
        
        //txtVelSzam2.setText(randomSzam + "");
        
        if(jCheckBox1.isSelected()== false)
        {
            int szam = random(randomFelso, randomAlso);
            txtVelSzam1.setText(szam + "");
            txtVelSzam2.setText(szam + "");
        }
        else
        {
            int szam1 = random(randomFelso, randomAlso);
            int szam2 = random(randomFelso, randomAlso);
            
            while(szam1 == szam2){
                szam1 = random(randomFelso, randomAlso);
            }
    ...
    /*public void visszaallitas(){ 
        int numMinReset = (int) numMin.getValue();
        int numMaxReset = (int) numMax.getValue();
        String txtVelszam1Reset = txtVelSzam1.getText();
        String txtVelszamReset = txtVelSzam2.getText();
        String jtxtAreaBalReset = jTextArea1.getText();
        String jtxtAreaJobbReset = jTextArea2.getText();
        boolean kulonbozoReset = jCheckBox1.isSelected();
        boolean kisRobotGomb1Reset = jRadioButton1.isSelected();
        boolean kisRobotGomb2Reset = jRadioButton2.isSelected();
        boolean mogeFuzReset = jCheckBox2.isSelected();
        boolean mindentMutatReset = jRadioButton3.isSelected();
    }*/
    ...
    private void btnTippInditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTippInditActionPerformed
        // TODO add your handling code here:
        
        
        
        
    }//GEN-LAST:event_btnTippInditActionPerformed
    ...
    private void kilepes(){
        ...
        int valasz = JOptionPane.showConfirmDialog(rootPane, uzenet, cim, 1);
    ...
    private javax.swing.JButton btnTippIndit;
